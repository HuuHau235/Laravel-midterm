            ...
            <div class="history-slider">
                ...
                <div class="history-slides">
                    <div> 
                        <div class="row">
                        <div class="col-sm-5">
                            <img src="source/assets/dest/images/history/history1.webp" alt="">
                        </div>
                        <div class="col-sm-7">
                    ...
                    <div> 
                        <div class="row">
                        <div class="col-sm-5">
                            <img src="source/assets/dest/images/history/history2.webp" alt="">
                        </div>
                        <div class="col-sm-7">
                    ...
                    <div> 
                        <div class="row">
                        <div class="col-sm-5">
                            <img src="source/assets/dest/images/history/history3.webp" alt="">
                        </div>
                        <div class="col-sm-7">
                    ...
                    <div> 
                        <div class="row">
                        <div class="col-sm-5">
                            <img src="source/assets/dest/images/history/history4.webp" alt="">
                        </div>
                        <div class="col-sm-7">
                    ...
                    <div> 
                        <div class="row">
                        <div class="col-sm-5">
                            <img src="source/assets/dest/images/history/history5.webp" alt="">
                        </div>
                        <div class="col-sm-7">
                    ...
                    <div> 
                        <div class="row">
                        <div class="col-sm-5">
                            <img src="source/assets/dest/images/history/history6.webp" alt="">
                        </div>
                        <div class="col-sm-7">
                    ...
                    <div> 
                        <div class="row">
                        <div class="col-sm-5">
                            <img src="source/assets/dest/images/history/history7.webp" alt="">
                        </div>
                        <div class="col-sm-7">
        ...
        <div class="row">
            <div class="col-sm-6 wow fadeInLeft">
                <div class="beta-person media">
                    ...
                    <img class="pull-left" src="source/assets/dest/images/history/history1.webp" alt="">
